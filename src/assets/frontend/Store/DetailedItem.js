                    ...
                    <div className={styles.container}>
                        <div className={styles.details_container}>
                                    ...
                                    <div className={styles.side_images_area}>
                                        {data.sub_images.map((url) => 
                                            <img 
                                                ...
                                                onClick={() => handleActiveImage(images[url].default)}  
                                            />
                                        )}
                                    </div> : null
                                }
                            ...
                            <div className={styles.info_container}>
                                ...
                                <p className={styles.priceArea}><strong style={{"opacity": "0.8"}}>Prix: </strong>
                                ...
                                <div className={styles.descriptionArea}>
                                    ...
                                    <div className={styles.description}>
                                        <p className={styles.descriptionSubTitle}>Product Details</p>
                                        <p className={styles.descriptionText}>{data.description}</p>
                                    </div>
                                    <p className={styles.dimension}><strong style={{"fontSize": "0.8rem", "fontWeight": "700"}}>Dimension: </strong> <span className={styles.dimensionNum}>{data.dimension}</span></p>
                                    
                                </div>
                                <div className={styles.deliveryInfoArea}>
                                    <p className={styles.deliveryInfoTitle}>Delivery Information</p>
                                    <ul className={styles.list}>
                                        {data.delivery_information.map(text => <li className={styles.listItem}>{text}</li>)}
                                    </ul>
                                </div>
                                <div className={styles.careInfoArea}>
                                    <p className={styles.careInfoTitle}>Care Information</p>
                                    <ul className={styles.list}>
                                        {data.care_information.map(text => <li className={styles.listItem}>{text}</li>)}
                                    </ul>
                                </div>
                        ...
                        <div className={styles.reviews_container}>
                            <h3 className={styles.reviewTitle}>What others say about this product</h3>
                            <div className={styles.reviewFlex}>
                                {data.reviews.map(review => 
                                    //remember to include key prop
                                    <div key={review.id} className={styles.reviewItem}>
                                        <div className={styles.reviewerInfo}>
                                            <img src={images[review.img].default} className={styles.reviewerImg} alt="reviewer profile" />
